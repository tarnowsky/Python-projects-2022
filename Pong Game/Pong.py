...
class Ball(Block):
    ...
    def restart_counter(self):
        ...
        # counter_view_rect = pygame.Rect((screen_width / 2 - 10, screen_height / 2 + 39, 20, 20))
...
game_menager = GameMenager(ball_sprite, paddle_group)
